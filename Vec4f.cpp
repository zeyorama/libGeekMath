...
Vec4f::Vec4f( const Vec3f& Axis, const float Angle )
{
...
Vec4f
Vec4f::Conjugate( void ) const
{
  return Vec4f( -m_Values[ 0 ], -m_Values[ 1 ], -m_Values[ 2 ], m_Values[ 3 ] );
}
...
Vec3f
Vec4f::Forward( void ) const
{
  return Vec3f( 0, 0,  1 ).Rotate( *this );
}

Vec3f
Vec4f::Backward( void ) const
{
  return Vec3f( 0, 0, -1 ).Rotate( *this );
}

Vec3f
Vec4f::Left( void ) const
{
  return Vec3f( -1, 0, 0 ).Rotate( *this );
}

Vec3f
Vec4f::Right( void ) const
{
  return Vec3f(  1, 0, 0 ).Rotate( *this );
}
