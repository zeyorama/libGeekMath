...
#ifndef LIBGEEKMATH_GEOMETRY_AABB_H_
#define LIBGEEKMATH_GEOMETRY_AABB_H_
...
{
public:
  AABB( const Vec3f& MinExtend, const Vec3f& MaxExtend );
  virtual
  ~AABB( void );
...
#endif /* LIBGEEKMATH_GEOMETRY_AABB_H_ */
